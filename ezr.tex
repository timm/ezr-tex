...
\lfoot{\footnotesize \texttt{Easier AI} \textbullet ~Less data, better results}
\cfoot{}
...
Potentially, there  are many parts to an AI analytics toolkit. For example,
in their survey of business intelligence needs of Microsoft managers, 
researchers found nine groups of analytics tasks, each of which needed
a different kind of analysis (regression, topic analysis, anomaly detection, what-if analysis,
etc):
