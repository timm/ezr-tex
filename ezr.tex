...
few data points (using incremental sampling). This minimal data usage
simplifies verification. The tool supports classification, regression,
optimization, fairness, explanation, data synthesis, privacy,
compression, planning, monitoring, and runtime certification
(but not  generative tasks). So while not everything can be simplified,
...
use \mbox{\verb+pip install ezr+}. To 
        Test that installation use \mbox{\verb+ezr -h+}.
